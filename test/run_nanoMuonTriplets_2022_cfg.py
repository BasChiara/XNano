...
globaltag = '124X_dataRun3_v15' if not options.isMC else '124X_mcRun3_2022_realistic_v12' 
...
if not options.inputFiles:
    options.inputFiles = ['/store/mc/Run3Summer22MiniAODv3/WtoTauNu_Tauto3Mu_TuneCP5_13p6TeV_pythia8/MINIAODSIM/124X_mcRun3_2022_realistic_v12-v2/2820000/0b14e03f-168c-4e39-b441-d1b949ee4890.root'] if options.isMC else \
